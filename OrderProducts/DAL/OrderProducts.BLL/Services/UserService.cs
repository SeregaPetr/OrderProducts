...
namespace OrderProducts.DAL.OrderProducts.BLL.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<OperationDetails> Create(UserDTO userDto)
        {
            ...
            {
                return new OperationDetails(false, "Пользователь с таким логином уже зарегистрирован", "Email");
            }
        }
        ...
        public async Task<ClaimsIdentity> Authenticate(UserDTO userDto)
        {
            ...
            else if (!string.IsNullOrEmpty(userDto.UserLogin))
            {
                // по Login
                user = await Database.UserManager.FindAsync(userDto.UserLogin, userDto.Password);
            }
